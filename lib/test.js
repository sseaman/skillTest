...
function Test(config) {
	if (!config || !config.name) throw new Error('name not specified');
	...
	if (!config || !config.expectedResult) throw new Error('expectedResult not specified');
...
Test.prototype = {
	...
	/**
	 * Returns the expected results of the test.  
	 *
	 * @function
	 * @return {Object} The result of the test
	 */
	getExpectedResult : function() {
		return this._config.expectedResult;
	},
